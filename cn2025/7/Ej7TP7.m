...
Tray = SimpsonCompDatos(tRK(1:31),compTray(1:31)); %31 es el valor para elcual t=3
 ...
 % calculo del instante de tiempo cuando estamos a una distancia del origen de 0.01
d = norm(x,2,"cols");
[~,p] = min(abs(d - 0.01));
...
hold off
t001=t(100);
disp('Instante de tiempo a partir del cual todos los puntos tienen una distancia al origen menor a 0.01')
disp(t001)
